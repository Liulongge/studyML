...
def get_hard_samples(svm,hog_features,labels):
    ...
    negs,hardlabel= read_neg_samples('/Users/runge.liu/Downloads/INRIAPerson/Train/neg')
...
def get_features(features,labels):
    pos_imgs,pos_labels = read_pos_samples('/Users/runge.liu/Downloads/INRIAPerson/Train/pos')
    computeHog(pos_imgs,features)
    
    [labels.append(1) for _ in range(len(pos_imgs))]
    
    neg_imgs,neg_labels = read_neg_samples('/Users/runge.liu/Downloads/INRIAPerson/Train/neg')
