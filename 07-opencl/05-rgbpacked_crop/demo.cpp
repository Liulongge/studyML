...
int main(void)
{
    ...
    int src_img_h = 494;
    int src_img_c = 3;
    int dst_x = (int)(src_img_w / 2) - (int)(src_img_w / 4);
    int dst_y = (int)(src_img_h / 2) - (int)(src_img_h / 4);
    ...
    cl_mem mem_dst_x = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(int), &dst_x, &error);
    cl_mem mem_dst_y = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(int), &dst_y, &error);
    ...
    error |= clSetKernelArg(kernel, 4, sizeof(cl_mem), (void *)&mem_dst_x);
    error |= clSetKernelArg(kernel, 5, sizeof(cl_mem), (void *)&mem_dst_y);
    error |= clSetKernelArg(kernel, 6, sizeof(cl_mem), (void *)&mem_dst_w);
    error |= clSetKernelArg(kernel, 7, sizeof(cl_mem), (void *)&mem_dst_h); 
    ...
    clReleaseMemObject(mem_dst_x);
    clReleaseMemObject(mem_dst_y);
